...
export const Orders = () => {
  ...
  // Prefill from Vehicles page
  const prefillHandled = useRef(false)
  useEffect(() => {
    if (prefillHandled.current || loading) return
  ...
  const openDetailModal = (order) => { setDetailOrder(order); setIsDetailModalOpen(true) }
                ...
                <TableRow key={order.id}>
                  ...
                  <TableCell>
                    <div className="flex gap-1.5">
                      ...
                      <Button size="sm" variant="outline" onClick={() => openDetailModal(order)} title="Detajet">
